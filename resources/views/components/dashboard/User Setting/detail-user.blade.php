<div id="detailModal" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 backdrop-blur-sm shadow-">
    <div class="dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-lg mx-auto overflow-y-auto max-h-screen">
        <h3 class="text-2xl font-bold text-white mb-4">Detail Data Alumni</h3>
        <div class="overflow-x-auto">
            <table class="min-w-full dark:bg-gray-800 rounded-lg">
                <tbody id="userDetail" class="text-gray-700">
